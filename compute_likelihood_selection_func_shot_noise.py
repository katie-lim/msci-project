...
def computeExpectation(l, m, n, l_prime, m_prime, n_prime, k_max, r_max, omega_matter, omega_matter_0, P, W_1st_terms, W_2nd_terms_without_delta_omega_m, nbar):
    ...
    # Shot noise term
    answer += nbar * W_1st_terms[l][n][n_prime]


    return answer


def computeLikelihood(f_lmn, k_min, k_max, r_max, omega_matter, omega_matter_0, W_1st_terms, W_2nd_terms_without_delta_omega_m, nbar):
    shape = f_lmn.shape
    ...
    for l in range(l_max + 1):
        ...
        for n1 in range(n_min_l, n_max_l + 1):
            for n2 in range(n_min_l, n_max_l + 1):
                ...
                sigma_l[n1 - n_min_l][n2 - n_min_l] = computeExpectation(l, 0, n1, l, 0, n2, k_max, r_max, omega_matter, omega_matter_0, p, W_1st_terms, W_2nd_terms_without_delta_omega_m, nbar)
