...
saveFileName = "data/f_lmn_0_lsst_true-%.3f_fiducial-%.3f_l_max-%d_k_max-%.2f_r_max_true-%.3f_cosine" % (omega_matter_true, omega_matter_0, l_max, k_max, r_max_true)
...
for omega_matter in omega_matters:
    ...
    W_saveFileName = "data/W_lsst_omega_m-%.4f_omega_m_0-%.4f_l_max-%d_k_max-%.2f_r_max_0-%.4f_cosine.npy" % (omega_matter, omega_matter_0, l_max, k_max, r_max_0)
    # S_saveFileName = "data/S_lsst_omega_m-%.4f_omega_m_0-%.4f_l_max-%d_k_max-%.2f_r_max_0-%.4f_cosine.npy" % (omega_matter, omega_matter_0, l_max, k_max, r_max_0)
